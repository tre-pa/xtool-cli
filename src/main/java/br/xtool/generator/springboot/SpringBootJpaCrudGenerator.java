...
public class SpringBootJpaCrudGenerator extends SpringBootGeneratorCommand {

	@ShellMethod(key = "gen-springboot-jpa-crud", value = "Gera uma classe de CRUD (JpaRepository, Service e Rest) para entidade JPA", group = XtoolCliApplication.SPRINGBOOT_COMMAND_GROUP)
